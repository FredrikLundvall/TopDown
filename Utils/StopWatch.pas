unit StopWatch;
 ...
 type TStopWatch = class
   ...
   public
     ...
     function GetElapsedSecondsWhenRunning: Double;
   end;
 ...
 function TStopWatch.GetElapsedSecondsWhenRunning: Double;
 var
   fRunningCount : TLargeInteger;
 begin
   SetTickStamp(fRunningCount);
   Result := ((MSecsPerSec * (fRunningCount - fStartCount)) div fFrequency ) / 1000.0;
 end;
